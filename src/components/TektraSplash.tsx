...
const TEXT_PATH =
  "M228.7 189.23 L280.12 240.42 L300.11 240.42 L239.17 179.7 Z M502.5,120.44h-9.75l-48.5,107.88-27.91-45.36c8.89-1.83,16.1-5.46,21.71-10.87,5.57-5.42,8.33-12.07,8.33-19.92,0-6.2-1.83-11.66-5.49-16.44-3.66-4.75-8.59-8.48-14.8-11.21-6.24-2.73-13.08-4.07-20.55-4.07h-120.86l-68.68,62.44v-62.44H32.49v7.21h43.2v112.77h14.39v-112.77h109.26v49.17h-64.76v7.21h64.76v49.17h-74.36v7.21h91.02v-48.05l71.22-64.72h42v112.77h14.39v-112.77h61.93c7.14,0,13.12,2.2,18.01,6.65,4.86,4.45,7.29,10.39,7.29,17.86s-2.43,13.56-7.29,18.01c-4.9,4.45-10.87,6.65-18.01,6.65h-10.05l39.91,63.6h10.61l2.39-5.34,44.35-98.76,48.35,104.1h15.25l-53.85-119.98Z";
            ...
            <svg viewBox="0 0 598.15 306.46" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
              ...
              {(stage === "drawIcon" || stage === "undrawIcon") && (
                <motion.path
                  ...
                  stroke="#1d1d1b"
                  strokeWidth={1.5}
                  initial={{ pathLength: stage === "drawIcon" ? 0 : 1 }}
                  animate={{ pathLength: stage === "drawIcon" ? 1 : 0 }}
                  transition={{
                    duration: stage === "drawIcon" ? DRAW_DURATION : UNDRAW_DURATION,
                    ease: "easeInOut",
                  }}
                  onAnimationComplete={() => {
                    if (stage === "drawIcon") {
              ...
              {stage === "drawText" && (
                <motion.path
                  ...
                  transition={{
                    ...
                    fillOpacity: { duration: 0.6, delay: TEXT_DURATION * 0.6 },
                  }}
                  style={{ fill: "#1d1d1b" }}
                  onAnimationComplete={() => {
                    setTimeout(() => {
