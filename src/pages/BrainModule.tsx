...
import { ArrowLeft, Brain, Send, Bot, User, Loader2, FileText, Mic, MicOff, History, Plus, MessageSquare } from "lucide-react";
              ...
              {conversations.length === 0 ? (
                ...
                conversations.map(conv => (
                  <button
                    ...
                    className={`w-full text-left p-2 rounded-md text-xs hover:bg-secondary/50 transition-colors ${
